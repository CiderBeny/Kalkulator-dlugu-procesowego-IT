...
recInnovation: (val) => `<strong style="color:var(--purple)">Innovation Lever:</strong> Debt backlog is blocking roadmap. Resolving it unlocks <strong>${PDE.formatCompactCurrency(val)}</strong> in project margin.`,
                ...
                verdictHero:       (x, y, z) => `Investing <strong>${x}</strong>, you save <strong>${y}</strong> annually, and payback occurs after <strong>${z}</strong>.`,
            ...
            pl: {
                ...
                verdictHero:       (x, y, z) => `Inwestując <strong>${x}</strong>, oszczędzasz <strong>${y}</strong> rocznie, a zwrot nastąpi po <strong>${z}</strong>.`,
