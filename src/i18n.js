...
recInnovation: (val) => `<strong style="color:var(--purple)">Innovation Lever:</strong> Debt backlog is blocking roadmap. Resolving it unlocks <strong>${PDE.formatCompactCurrency(val)}</strong> in project margin.`,
            ...
            pl: {
                ...
                methodologyAdvancedBody:     'Siedem parametrów w panelu "Advanced Parameters" pozwala w czasie rzeczywistym nadpisać domyślne współczynniki: Współczynnik Erozji Pipeline (0,0–1,0), WACC / Stopa Dyskontowa (5–20%), Horyzont Czasu NPV (3–10 lat), Dźwignia Automatyzacji (10–60%), Dźwignia Ryzyka (20–80%), Premia za Przełączanie Kontekstu (0–30%) i Stawka Podatku CIT (0–50%, dla tarczy podatkowej amortyzacji CAPEX). Zmiana dowolnego suwaka natychmiast przelicza wszystkie zależne metryki. Wartości domyślne przywracane są przy przeładowaniu strony.',
