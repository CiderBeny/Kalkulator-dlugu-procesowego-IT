...
const TRANSLATIONS = {
            en: {
                ...
                contextPremiumSource: 'Source: PanDev Metrics 2026 · TheTab 2025 · Weinberg 1992',
...
recInnovation: (val) => `<strong style="color:var(--purple)">Innovation Lever:</strong> Debt backlog is blocking roadmap. Resolving it unlocks <strong>${PDE.formatCompactCurrency(val)}</strong> in project margin.`,
                ...
                methodologyTotalFormula:     'OPEX Waste (×1.15 context-switching premium) + Risk Exposure + Pipeline Margin Erosion',
                methodologyTotalNote:        'Pipeline Margin Erosion (cOppDirect) is a one-time estimate reflecting margin lost in the first year of delay. OPEX Waste includes a built-in 15% context-switching premium (×1.15). All other components recur annually.',
            ...
            pl: {
                ...
                contextPremiumSource: 'Źródło: PanDev Metrics 2026 · TheTab 2025 · Weinberg 1992',
                ...
                methodologyTotalFormula:       'OPEX Waste (×1,15 premia za przełączanie kontekstu) + Ekspozycja na Ryzyko + Erozja Marży Pipeline',
                methodologyTotalNote:          'Pipeline Margin Erosion (cOppDirect) to szacunek jednorazowy — marża utracona w pierwszym roku opóźnienia. OPEX Waste zawiera wbudowaną premię 15% za przełączanie kontekstu (×1,15). Pozostałe składniki są cykliczne rocznie.',
                ...
                methodologyAdvancedBody:     'Pięć parametrów w panelu "Advanced Parameters" pozwala w czasie rzeczywistym nadpisać domyślne współczynniki: Współczynnik Erozji Pipeline (0,0–1,0), WACC / Stopa Dyskontowa (5–20%), Horyzont Czasu NPV (3–10 lat), Dźwignia Automatyzacji (10–60%) i Dźwignia Ryzyka (20–80%). Zmiana dowolnego suwaka natychmiast przelicza wszystkie zależne metryki. Wartości domyślne przywracane są przy przeładowaniu strony.',
