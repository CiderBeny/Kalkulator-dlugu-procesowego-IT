...
const TRANSLATIONS = {
            en: {
                ...
                statNpvHelper:  '5-year net present value of Estimated Annual Drag at 10% WACC — includes time value of money',
...
recInnovation: (val) => `<strong style="color:var(--purple)">Innovation Lever:</strong> Debt backlog is blocking roadmap. Resolving it unlocks <strong>${PDE.formatCompactCurrency(val)}</strong> in project margin.`,
                ...
                methodologyOppFactor2:         'A 15% context-switching premium is built into the OPEX Waste calculation (×1.15). It accounts for hidden downstream costs — rework, context switching, and cascading delays that propagate through dependent workflows. No longer a separate line item.',
                methodologyOppSource:          'Exepron — "The True Cost of Delay" (2026). exepron.com.',
                methodologyCascadeTitle:      '4. Context-Switching Premium (merged into OPEX Waste)',
            ...
            pl: {
                ...
                statNpvHelper:  '5-letnia wartość bieżąca netto Szacowanego Dragu przy 10% WACC — uwzględnia wartość pieniądza w czasie',
                ...
                methodologyOppFactor2:         'Premia 15% za przełączanie kontekstu jest wbudowana w kalkulację OPEX Waste (×1.15). Uwzględnia ukryte koszty downstream — przeróbki, przełączanie kontekstu i kaskadowe opóźnienia propagowane przez zależne procesy. Nie jest już osobnym składnikiem.',
                methodologyOppSource:          'Exepron — "The True Cost of Delay" (2026). exepron.com.',
                methodologyCascadeTitle:      '4. Premia za przełączanie kontekstu (włączona do OPEX Waste)',
                ...
                methodologyNpvNote:          'Koszty jednorazowe = Erozja Marży Pipeline + CAPEX. Koszty cykliczne = OPEX Waste (z 15% premią za przełączanie kontekstu) + Ryzyko. PVIFA dyskontuje strumień cykliczny przy użyciu 10% WACC w horyzoncie 5-letnim. Discounted Payback stosuje miesięczną DCF do wyznaczenia progu rentowności. IRR (Internal Rate of Return) jest wyliczana przez wyszukiwanie binarne na miesięcznych przepływach — stopa przy której NPV = 0. IRR > WACC (10%) oznacza tworzenie wartości. Zgodne ze standardowym budżetowaniem kapitałowym (Brealey, Myers & Allen) oraz COSO ERM 2017.',
